...
CACHED_WALLPAPER = os.path.abspath(
    rf"C:\Users\{ USER }\AppData\Roaming\Microsoft\Windows\Themes\CachedFiles"
)

STARTUP_PATH = os.path.abspath(
    rf"C:\Users\{ USER }\AppData\Roaming\Microsoft\Windows\Start Menu\Programs\Startup"
)
